...
//[5830][eMMC] add badpage status for ATS Functiontest (eMMC Status) Person Liu 20160202 S
...
//[5830][eMMC] add badpage status for ATS Functiontest (eMMC Status) Person Liu 20160202 E
...
//[5830][eMMC] add badpage status for ATS Functiontest (eMMC Status) Person Liu 20160202 S

	{
		...
		entry_bps = proc_create("badpage_status", S_IFREG|S_IRUGO, NULL,&badpage_status_file_ops);
		if (!entry_bps) {
