...
enum eeprom_cfg_type_t {
	...
	//[kent][16022601][begin]verify t4k37 product information
	CFG_EEPROM_GET_PRODUCT_INFO,
	//[kent][16022601][end] verify t4k37 product information
	//[5833]Add for Main Camera 2nd source 20160614 S
	CFG_EEPROM_GET_MODULE_ID,
...
//[kent][16022602][begin] verify t4k37 product information
struct eeprom_get_product_info {
	uint32_t module_sn;
	uint32_t module_pn;
	uint32_t module_id;//[5833]Add for Main Camera 2nd source 20160614
};
//[kent][16022602][end] verify t4k37 product information
struct msm_eeprom_cfg_data {
	...
	union {
		...
		//[kent][16022603][begin] verify t4k37 product information
		struct eeprom_get_product_info product_info;
		//[kent][16022603][end] verify t4k37 product information
	} cfg;
};
